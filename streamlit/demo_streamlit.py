...
# Dividir la lista en dos partes y mostrarlas en columnas separadas
with col1:
    for item in class_names[:5]:  # Primera mitad de la lista
        st.write(f"- {item}")

with col2:
    for item in class_names[5:]:  # Segunda mitad de la lista
        st.write(f"- {item}")
